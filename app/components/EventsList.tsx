...
export default function EventsList({ events = [] }: { events: Event[] }) {
    ...
    return (
        <section className="relative w-full bg-white py-16 md:py-24 lg:py-32 px-6 md:px-12 text-black">
                ...
                <div className="flex-1 w-full">
                    <div className="flex justify-between items-end mb-12 md:mb-16">
                        ...
                        <Link href="/events" className="hidden md:flex text-xs font-bold font-inter tracking-widest uppercase items-center gap-2 border-b border-black pb-1 hover:text-orange-600 hover:border-orange-600 transition-colors">
                            Full Calendar <ArrowUpRight className="w-4 h-4" />
                        </Link>
                    </div>
                    ...
                    <div className="flex flex-col w-full">
                        {events.length === 0 ? (
                            ...
                            <div
                                ...
                                className="group relative border-t border-neutral-200 py-6 md:py-10 lg:py-12 cursor-pointer transition-all duration-300 hover:border-black"
                            >
                                <div className="flex items-center justify-between gap-4">
                                    ...
                                    <div className="hidden md:flex flex-col items-end gap-1 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                        <span className="font-syne font-bold text-lg">{event.price}</span>
                                        <a href={event.ticket_url} target="_blank" rel="noopener noreferrer" className="text-[10px] uppercase font-bold tracking-widest underline decoration-orange-600 decoration-2 underline-offset-4 pointer-events-auto">
                                            Get Tickets
                                        </a>
                                    </div>
                            ...
                            >
                                ...
                                <div className="absolute bottom-0 left-0 w-full p-8 bg-gradient-to-t from-black/80 to-transparent text-white">
                                    ...
                                    <a
                                        ...
                                        className="inline-block mt-6 px-8 py-3 bg-white text-black font-bold uppercase tracking-widest text-xs hover:bg-orange-600 hover:text-white transition-colors"
                                    >
                                        Buy Tickets
                                    </a>
                                </div>
